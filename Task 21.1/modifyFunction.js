...
// В прикладі вказано, що при 4 вона повертає 16 (тобто множить на 4 або підносить до квадрата).
function originalFunction(num) {
  return num * 4; 
}

function modifyFunction(originalFunc, multiplier) {
  // Повертаємо нову функцію, яка приймає аргумент
  return function(num) {
    // Викликаємо оригінальну функцію і множимо її результат на multiplier
...
console.log('Modified function output for 4:', modifiedFunc(4));     // 48 (16 * 3)
