...
function getRandomInt(min, max) {
  // 1. Отримуємо випадкове число від 0 до 1 за допомогою Math.random()
  // 2. Множимо на (max - min + 1), щоб отримати потрібну кількість варіантів
  // 3. Округлюємо вниз за допомогою Math.floor()
  // 4. Додаємо min, щоб змістити початок діапазону
  return Math.floor(Math.random() * (max - min + 1)) + min;
}

// Використання функції для різних діапазонів
